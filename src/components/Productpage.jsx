...
const ProductPage = ({ onOpenCart }) => {
  ...
  if (!product) return (
    <div className="min-h-screen bg-[#FFEDFA] flex items-center justify-center">
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-[#FFEDFA] overflow-x-hidden">
      {showSuccess && (
      ...
      <Header />
      <div className="layout-container flex h-full grow flex-col bg-[#FFEDFA]">
